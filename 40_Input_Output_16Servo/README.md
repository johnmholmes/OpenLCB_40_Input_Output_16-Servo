...
ESP32 Universal Example.

This sketch implements: 
Native channels, using the processors pins:
  * 0 or 8 i/o channels, each of which can be an input or an output,
  ...
  * Native depends on the processor, see board.h for pin allocation.
MCP23017 Port Expanders
  * 0-4 depending if PCAs are being used.
  * Default is set to Input with Pullup(To protect the chip in the event of being ground out.)
...
PCA9685 Servo Boards
  * 0-3 Depending on the number of MCPs choosen.
